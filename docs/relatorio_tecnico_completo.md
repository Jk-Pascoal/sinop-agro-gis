...
│   └── 07_logistica_infraestrutura.ipynb
│
...
### NOTEBOOK 07 — Análise da Malha Viária e Infraestrutura Logística
**Arquivo:** notebooks/07_logistica_infraestrutura.ipynb  
**Status:** Criado  
**Data de execução:** 2026-05-23

#### Objetivo
Mapear e analisar espacialmente a infraestrutura de transporte rodoviário em Sinop-MT, calculando a extensão, classificação das vias e destacando a rodovia federal BR-163.
...
**Seção 1 — Carregamento dos Shapefiles**
- Carregamento de `sinop_recorte.shp` e `sinop_rodovias.shp`.

**Seção 2 — Reprojeção e Métricas Espaciais**
- Reprojeção para CRS UTM 21S (EPSG:31981) para cálculos métricos.
- Área de Sinop-MT: 3.990,86 km² (399.085 ha).
- Extensão Total da Malha Viária: 1.842,15 km.
- Densidade Viária: 0,462 km de vias por km² de área.

**Seção 3 — Classificação e Extensão por Tipo de Via**
- Classificação das estradas (fclass):
  - *Track* (estradas rurais/vias de terra): 1.228,15 km (66,7%).
  - *Residential* (vias urbanas residenciais): 348,65 km (18,9%).
  - *Rodovias Estaduais/Locais (Secondary/Tertiary):* 85,50 km (4,6%).
  - *Rodovia Federal (Trunk/Primary):* 72,82 km (4,0%).
- Isola a BR-163 com extensão de 63,85 km cruzando o território municipal.

**Seção 4 — Visualização Cartográfica da Malha Viária**
- Arquivo: `maps/exportados/15_malha_viaria_sinop.png`
- Mapa espacial temático exibindo a malha de vias com destaque para a BR-163.
...
- [x] Publicar mapa interativo online com Folium/GitHub Pages
